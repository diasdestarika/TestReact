...
class ResiPageAlready extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      result: [],
  ...
  componentDidMount() {
    this.props.setTitle(
      'Pesanan Yang Harus Kejar Ekspedisi Agar Tidak Cancel (L5)',
      'red',
    );
            ...
            <Card className="mb-3">
              ...
              <CardBody>
                <Row>
                  <Col>
                    {/* <Card className="mb-3"> */}
                    {/* <CardHeader style={{ backgroundColor: '#047873', color: 'white', textAlign:'center' }}> <Label style={{ textAlign: 'center', fontSize: '20px' }}><b></b></Label></CardHeader> */}
                    {/* <CardBody> */}
                    {/* already */}
...
export default ResiPageAlready;
