...
class ReceivingNPage extends React.Component {
  ...
  getDetailPO(group, dataPO, gudangID) {
    ...
    fetch(url, option)
      ...
      .then(data => {
        // console.log('TESTING DATA BENTO', data);
        var allData = data;
  ...
  render() {
    ...
    // console.log('CURRENTTODOS APA?', currentTodos === null);
            ...
            <Card style={{ marginBottom: '1%' }}>
              <CardHeader id="scanNoPO" style={{ display: 'block' }}>
                <Form inline>
                  ...
                  {/* {console.log('ISI HEADERPO', headerPO)} */}
                  <Input
                    type="search"
                    className="text-left"
                    style={{ width: '20%' }}
                    ...
                    // value={
                    //   headerPO && headerPO.rcvh_nopo ? headerPO.rcvh_nopo : null
                    // }
  ...
  canBeSubmittedConfirm() {
    ...
    // console.log('ISINYA APA AJA: ', headerPO);
    // console.log('ISINYA APA AJA 2: ', listTampil[0] && listTampil[0].batch[0].rcvd_nobatch);
    // console.log('ISINYA APA AJA 3: ', firstLoad);
    // console.log('ISINYA APA AJA 4: ', namaKaryawan);
    ...
    console.log('ISINYA APA AJA 4: ', tanggalFaktur.includes('Z'));
    console.log('ISINYA APA AJA 5: ', tanggalSurat.includes('Z'));
    console.log(
      'ISINYA APA AJA 6: ',
      headerPO !== undefined &&
    ...
    // for (var key in headerPO) {
    //   if (headerPO[key] === '' || headerPO[key] === 0) {
    //     flag = false;
    //     break;
    //   }
    // }
    ...
    //     var currObj = this.formatTabel(listTampil[i]);
    //     if (currObj.rcvd_quantityrecv > currObj.rcvd_quantitypo) {
    //       flag = false;
    //       break;
    //     }
    //   }
    ...
    //   listTampil = [];
    // }
    // if (namaKaryawan === '') flag = false;
    // return flag && !firstLoad;

    // for (let i = 0; i < listTampil.length; i++) {
    //     var currObj = this.formatTabel(listTampil[i]);
    //     if (currObj.rcvd_quantitypo !== currObj.rcvd_quantityrecv) {
    //         flag = false;
    //         break;
    //     }
    // }
